...
namespace EditorExtension.TreeViewExample.Editor
{
    public class TreeViewExample : EditorWindow
    {
        ...
        [MenuItem("EditorExtension/12.TreeView/Open")]
        ...
        private void OnGUI()
        {
            ...
            mSimpleTreeView.OnGUI(GUILayoutUtility.GetRect(0, 100000, 0, 100000));
        }
